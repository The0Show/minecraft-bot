...
module.exports = {
    ...
    callback: async (message, args, text, client, prefix, instance) => {
        ...
        if(!message.args.length) return message.channel.send(introembed)
    
        message.channel.startTyping(100)
    
        if(message.args[0] === 'stats'){
            if(!message.args[1]) return message.channel.send('Usage: `mcb!2b2t stats <minecraft username>`')
        ...
        if(message.args[0] === 'queue'){
            ...
            .setTitle('2b2t Queue')
            .addField('Regular', regqueueinfo[1] + " players", true)
            .addField('Priority', prioqueueinfo[1] + " players", true)
